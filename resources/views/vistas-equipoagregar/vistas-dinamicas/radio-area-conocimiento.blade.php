                ...
                success: function (data) {
                    ...
                    data.forEach(area => {
                        ...
                        table.row.add([ 
                            ...
                            area.Nombre,
                            `
                                <button class="btn-editar" data-id="${area.ID_Area}" onclick="editarArea(this)">
                                    ✏️ Editar
                                </button>
                                <button class="btn-eliminar" data-id="${area.ID_Area}">
                                    ❌ Eliminar
                                </button>
                                <button class="btn-aceptar" data-id="${area.ID_Area}" style="display: none;" onclick="actualizarArea(${area.ID_Area})">
                                    ✔️ Aceptar
                                </button>
